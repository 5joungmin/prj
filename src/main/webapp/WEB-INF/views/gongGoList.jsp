...
/* 라벨 스타일링 */
form[name="gonggoSearchForm"] label {
    margin-right: 10px;
    margin-bottom: 5px;
}

/* 셀렉트 박스 스타일링 */
form[name="gonggoSearchForm"] select {
    padding: 5px;
    border-radius: 5px;
...
/* 키워드 입력 필드 스타일링 */
form[name="gonggoSearchForm"] input[type="text"] {
    padding: 5px;
    border-radius: 5px;
    border: 1px solid #ccc;
    margin-right: 10px;
...
/* 검색 버튼 스타일링 */
form[name="gonggoSearchForm"] input[type="button"] {
    padding: 5px 10px;
    border-radius: 5px;
    border: none;
...
/* 검색 버튼 호버 효과 */
form[name="gonggoSearchForm"] input[type="button"]:hover {
